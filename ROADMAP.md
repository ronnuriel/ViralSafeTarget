...
## v0.2 — repository-ready research alpha

- [x] Reproducible Python package and CLI
- [x] SpCas9/NGG scanning on both strands
- [x] GFF3 annotation mapping
- [x] Cas-OFFinder export and result summarization
- [x] Cross-platform and shell-based HSV-2 pilot download paths
- [x] Idealized sequence-level two-cut deletion simulation
...
- [ ] Separate evidence layers for conservation, essentiality, accessibility and host risk
- [ ] Calibrated uncertainty rather than one arbitrary total score

## v1.0 — validated research tool

Requires an external public benchmark, independent reproduction and at least one prospective experimental collaboration. Version 1.0 would still not imply a therapeutic or clinical claim.
